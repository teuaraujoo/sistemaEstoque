    ...
    return (
        <aside className="flex h-[calc(100vh-250px)] flex-col rounded-3xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="border-t border-slate-200 px-6 py-5">
                ...
                <button className="w-full rounded-2xl bg-indigo-600 px-4 py-3.5 text-base font-semibold text-white shadow-sm transition cursor-pointer hover:bg-indigo-700">
                    Finalizar Venda
                </button>
            </div>
        </aside>
